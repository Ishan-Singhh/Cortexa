...
import logo from '../assets/favicon_bw.svg';
        ...
        <>
            ...
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-black">
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    {/* <a href="/">
                        <svg width="31" height="34" viewBox="0 0 31 34" fill="none" xmlns=".\src\assets\favicon_bw.svg">
                    ...
                    <Link to="/"> 
                        <img src={logo} alt="Cortexa Logo" width="48" height="50" />
                    </Link>
                    <div>
                        ...
                        <ul className="mt-2 space-y-2">
                            ...
                            <li><Link to="/upload" className="hover:text-indigo-600 transition">Upload MRI</Link></li>
                            <li><Link to="/history" className="hover:text-indigo-600 transition">History</Link></li>
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    <p className="max-w-60">For a clearer diagnosis and a better tomorrow.</p>
                    ...
                    <p className="mt-3 text-center">© 2025 <a href="https://prebuiltui.com">Cortexa</a></p>
                </div>
            </footer>
        </>
    );
